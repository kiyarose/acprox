...
function setTab(name = document.querySelector('#tabname').value,
  ...
  if (localStorage.getItem("tabName")) document.querySelector("#tabname")
      .value = localStorage.getItem("tabName")
  if (localStorage.getItem("tabIcon")) document.querySelector("#tabicon")
      .value = localStorage.getItem("tabIcon")
}
...
let tabPresets =
    {
      ...
      default : {
        name : 'SLA',
        icon :
            'https://status.sillylittle.tech/assets/status_pages_v2/favicons/maintenance-ede24b7d5f20832cad20ad3745dac7afe16404eee1ad021db9c1585d7cd60815.png'
      }
    }
    // Set tab presets
    ...
    if (localStorage.getItem("tabName")) document.querySelector("#tabname")
        .value = localStorage.getItem("tabName")
if (localStorage.getItem("tabIcon")) document.querySelector("#tabicon").value =
    localStorage.getItem("tabIcon")
if (localStorage.getItem("theme")) document.querySelector("#theme-select")
...
if (localStorage.getItem("panickey"))
  ...
  if (localStorage.getItem("panicurl")) document.querySelector("#panicurl")
      .value = localStorage.getItem("panicurl")
